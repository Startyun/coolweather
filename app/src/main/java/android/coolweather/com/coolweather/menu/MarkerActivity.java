...
//
//
//                Toast.makeText(MarkerActivity.this,llInfo.toString(), Toast.LENGTH_SHORT).show();
//
//
...
//                        fromResource(R.mipmap.ic_launcher_30)));
        ...
        Toast.makeText(MarkerActivity.this, result.getAddress()+result.getSematicDescription(), Toast.LENGTH_LONG).show();
    }
